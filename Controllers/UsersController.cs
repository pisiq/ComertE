...
namespace Hotel.Controllers
{
    public class UsersController : Controller
    {
        ...
        public async Task<IActionResult> Profile()
        {
            ...
            // Get the user's bookings using service methods
            var activeBookings = await _bookingService.GetUserActiveBookingsAsync(user.Id);
            var pendingBookings = await _bookingService.GetUserPendingBookingsAsync(user.Id);
            var pastBookings = await _bookingService.GetUserPastBookingsAsync(user.Id);
            var cancelledBookings = await _bookingService.GetUserCancelledBookingsAsync(user.Id);
